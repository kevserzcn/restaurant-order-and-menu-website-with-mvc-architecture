...
Contact Service
===============
İletişim/Yorum iş mantığı.

SOLID: Single Responsibility - Sadece contact business logic
"""
...
class ContactService:
    ...
    def reply_to_contact(self, contact_id: int, reply_text: str, 
        ...
        """İletişim kaydına cevap yaz ve e-posta gönder"""
    ...
    def get_statistics(self) -> Dict:
        """İletişim istatistiklerini hesapla"""
        ...
        # Ortalama puan (sadece yorumlar için)
