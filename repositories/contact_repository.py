...
Contact Repository
==================
İletişim/Yorum veritabanı işlemleri.

SOLID: Single Responsibility - Sadece Contact CRUD
"""
...
class ContactRepository(BaseRepository[Contact]):
    """İletişim/Yorum repository"""
    
    def __init__(self):
        super().__init__(Contact)
    
    def get_all_ordered_by_date(self) -> List[Contact]:
        """Tüm kayıtları tarihe göre sıralı getir (en yeni önce)"""
    ...
    def get_visible_comments(self) -> List[Contact]:
        """Görünür yorumları getir (sadece comment tipi)"""
