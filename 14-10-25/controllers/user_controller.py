...
def cancel_order(order_id):
    ...
    # İptal edilebilir mi? Kullanıcı için izin: yalnızca 'pending' durumundaki siparişler
    if order.status != 'pending':
        flash('Sadece henüz ödeme veya hazırlama aşamasına geçmemiş siparişleri iptal edebilirsiniz.', 'error')
